...
{
    public partial class CCCService
    {
        ...
        {
            //var objCatUsers = (from CCC in dbContext.CategoryContentComments
            //                   join CC in dbContext.CategoryContents on CCC.ContentId equals CC.Id
            //                   join C in dbContext.Categories on CC.CategoryId equals C.CategoryId
            //                   join U in dbContext.Users on CCC.UserId equals U.UserId
            //                   where CCC.ContentId == NodeId && U.UserId != UserId
            //                   select new CategoryCommentDetailUsers
            //                   {
            //                       CategoryID = CC.CategoryId,
            //                       CategoryName = C.Name,
            //                       ChannelNo = C.ChannelNo,
            //                       Comment = CCC.Comments,
            //                       CommentDate = CCC.CommentDate,
            //                       CommentID = CCC.Id,
