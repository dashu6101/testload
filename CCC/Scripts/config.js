CKEDITOR.editorConfig = function (config) {
    ...
    config.extraPlugins = 'doksoft_instant_image';
	...
	{ name: 'insert', items: [ 'doksoft_instant_image','HorizontalRule','SpecialChar'] }	
];
	config.toolbar='MyToolbar';
	config.doksoft_uploader_url = '/Home/UploadImage';	
	config.doksoft_instant_image_template = '<img style="max-width:100%" src="{IMAGE}"/>';
