...
namespace DeliverLoad.Models
{
    ...
    public partial class DeliverLoadEntities : DbContext
    {
        public DeliverLoadEntities()
            : base("name=DeliverLoadEntities")
        {
        }
        ...
        public DbSet<UserBankInformation> UserBankInformations { get; set; }
        ...
        public virtual ObjectResult<PR_GET_PARTICIPANT_CHANNEL_LIST_Result> PR_GET_PARTICIPANT_CHANNEL_LIST(Nullable<int> userD)
        {
            var userDParameter = userD.HasValue ?
                new ObjectParameter("UserD", userD) :
                new ObjectParameter("UserD", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PR_GET_PARTICIPANT_CHANNEL_LIST_Result>("PR_GET_PARTICIPANT_CHANNEL_LIST", userDParameter);
        }
    
        public virtual ObjectResult<PR_GET_PARTICIPANT_REQUESTED_CHANNEL_LIST_Result> PR_GET_PARTICIPANT_REQUESTED_CHANNEL_LIST(Nullable<int> userD)
        {
            var userDParameter = userD.HasValue ?
                new ObjectParameter("UserD", userD) :
                new ObjectParameter("UserD", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PR_GET_PARTICIPANT_REQUESTED_CHANNEL_LIST_Result>("PR_GET_PARTICIPANT_REQUESTED_CHANNEL_LIST", userDParameter);
        }
    }
}
